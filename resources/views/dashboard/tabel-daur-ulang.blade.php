...
<!-- MODAL INPUT Data Produk Daur Ulang / KOMPOS -->
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Contoh: Sisa Sayuran " required>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" placeholder="Contoh: 2.4 kg" min="1" required>
                            </div>
                            <div class="mb-3">
